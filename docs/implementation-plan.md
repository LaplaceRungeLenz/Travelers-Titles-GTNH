...
- [x] M6: README, resource-pack guide, example pack, license and test report. Review changes, commit, create new private GitHub repo, push, verify private visibility, remote SHA, zero releases.
